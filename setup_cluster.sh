...
ssh root@192.168.10.103 "docker volume create ${CHIA_PLOTS} -o device=/srv/dev-disk-by-uuid-0c84cc82-b2fa-40f8-8d48-237032b6b48f/chia/plots/ ${OPT}"
...
ssh root@192.168.10.103 "docker volume create ${DOCER_DIR} -o device=/var/lib/docker/ ${OPT}"
